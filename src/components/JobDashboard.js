...
const JobDashboard = () => {
  ...
  const ChartSkeleton = () => (
    <div className="relative bg-green-50 rounded-lg p-4 animate-pulse">
  ...
  const JobListSkeleton = () => (
    <ul className="space-y-4">
      {[...Array(5)].map((_, i) => (
        <li key={i} className="flex items-center justify-between p-3 bg-white shadow-md rounded-lg animate-pulse">
